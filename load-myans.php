...
$user = $_SESSION['user'];
$select_query=mysqli_query($con,"SELECT * FROM response WHERE response_by='$user'");
$i = 1;
...
if(!isset($_GET['q']) || !isset($_GET['qby']))
{
	...
	{
		$qby=$result['response_to_user'];
		$q=$result['response_to_question'];
		...
		$output .= "<h3 id='qlink".$i."'><a class='qlink' href='qlinks.php?q=".$q."&qby=".$qby."'>".$q."</a>";
